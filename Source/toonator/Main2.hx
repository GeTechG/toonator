...
class Main2 extends MovieClip
{
    ...
    private function onSessionLoadComplete(param1 : Event) : Void
    {
        ...
        if (_loc2_.result != "ok")
        {
            ...
            {
                this.saveComplete.lblLink.htmlText = "ошибка при загрузке";
            }
    ...
    private function onLoadComplete(param1 : Event) : Void
    {
        ...
        if (_loc2_ == 2)
        {
            ...
            while (_loc4_ < _loc3_.length)
            {
                if (_loc4_ > 0)
                {
                    this.OnAddFrameCrutch(null, true);
                }
    ...
    private function OnAddFrameCrutch(param1 : Event = null, param2 : Bool = false):Void
    {
        ...
        else
        {
            ...
            //this.frames.splice(this.curFrame, 0);
            //this.frames[this.curFrame] = _loc3_;
        }
        if (!param2)
        {
    ...
    private function onSaveClick(param1 : Event) : Void
    {
        ...
        Reflect.setField(_loc15_, "isdraft", this.saveForm.checkDraft.isChecked ? '1' : '0');
